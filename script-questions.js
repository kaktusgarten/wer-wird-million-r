const quizQuestions = [
  ...
  {
    question: "Welches Planet ist der dritte von der Sonne?",
    answers: [
  ...
  {
    question: "In welcher Sportart wird der Begriff 'Hole-in-One' verwendet?",
    answers: [
  ...
  {
    question: "Was ist das Hauptnahrungsmittel in Japan?",
    answers: [
      { text: "Nudeln", correct: false },
      { text: "Reis", correct: true },
